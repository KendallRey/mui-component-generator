...
function deconstructComponentSetup(component) {
  if (typeof component === 'object') {
    const { name, exports, typeGenerics, typeGenericsApplied, componentTypes } = component,
      otherProps = __rest(component, ['name', 'exports', 'typeGenerics', 'typeGenericsApplied', 'componentTypes'])
    return Object.assign(
      {
        componentName: name,
        exports: (exports === null || exports === void 0 ? void 0 : exports.length) ? exports.join(',') : null,
        typeGenerics: (typeGenerics === null || typeGenerics === void 0 ? void 0 : typeGenerics.length)
          ? typeGenerics.join(',')
          : null,
        typeGenericsApplied: (
          typeGenericsApplied === null || typeGenericsApplied === void 0 ? void 0 : typeGenericsApplied.length
        )
          ? typeGenericsApplied.join(',')
          : null,
        componentTypes: (componentTypes === null || componentTypes === void 0 ? void 0 : componentTypes.length)
          ? componentTypes.join(',')
          : null,
      },
      otherProps,
...
COMPONENTS.forEach((component) => {
  const _a = deconstructComponentSetup(component),
    { componentName } = _a,
    otherProps = __rest(_a, ['componentName'])
  const componentPath = path.join(componentsDir, componentName)
  fs.mkdirSync(componentPath, { recursive: true })
  const content = mustache_1.default.render(
    componentTemplate,
    Object.assign(
      { prefix, customName: `${styledPrefix}${componentName}`, name: componentName, directive },
      otherProps,
    ),
  )
